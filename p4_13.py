...
O = Point(position_x=0., position_y=0., velocity_y=0., velocity_x=-1., acceleration_y=0., acceleration_x=4.)
A = Point(position_x=0., position_y=R_1, velocity_y=0)
B = Point(position_x=0., position_y=-R_1, velocity_x=-2., acceleration_x=8)
D = Point(position_x=R_1, position_y=0)
